...
// 			if wnaf[i] > 0 {
// 				idx = uint64(wnaf[i] >> 1)
// 				g.Add(qBig, qBig, precompTable[indexForPositive+idx])
// 			} else {
// 				idx = uint64(((0 - wnaf[i]) >> 1))
// 				g.Add(qBig, qBig, precompTable[indexForPositive-1-idx])
// 			}
// 		}
// 	}
// 	return c.Set(qBig)
...
// 	z := new(fe2).one()
// 	qBig := &PointG2{*x, *y, *z}
// 	g.ClearCofactor(qBig)
// 	return g.Affine(qBig), nil
// }
