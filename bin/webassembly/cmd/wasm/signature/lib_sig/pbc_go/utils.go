...
// SetCryptoRandom causes PBC to use the cometcrypto/rand package with the globally
// shared rand.Reader as the source of random numbers.
func SetCryptoRandom() { SetReaderRandom(cryptorand.Reader) }

// SetReaderRandom causes PBC to use the cometcrypto/rand package to generate random
